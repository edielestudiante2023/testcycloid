<div style="font-family: system-ui, -apple-system, Arial, sans-serif; max-width: 480px; margin: 0 auto; color: #1b1f27;">
    <h1 style="font-size: 20px;"><?= esc($dinamicaNombre) ?></h1>
    <p>Hola <?= esc($nombre) ?>,</p>
    <p>El ejercicio está por comenzar.</p>
    <?php if (!empty($introUrl)): ?>
    <p style="text-align:center; margin: 20px 0 4px;">
        <a href="<?= esc($introUrl) ?>" style="color:#0345BF; font-weight:600; text-decoration:underline;">Conoce el contexto antes de empezar</a>
    </p>
    <?php endif; ?>
    <p>Haz clic en el siguiente botón para ver tu rol — es información confidencial, solo para ti.</p>
